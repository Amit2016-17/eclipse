...
import org.rtthread.wizard.RDTPluginMessage;
...
public class RTTPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		this.rttDirectoryEditor = new DirectoryFieldEditor(RTT_ROOT, RDTPluginMessage.RTPreferencePage_RTThread, getFieldEditorParent());
