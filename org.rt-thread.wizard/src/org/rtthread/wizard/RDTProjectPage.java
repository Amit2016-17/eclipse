...
public class RDTProjectPage extends WizardNewProjectCreationPage implements IWizardItemsListListener {
	...
	private void initDate() {
		...
		items.add(RDTPluginMessage.RDTMainWizardPage_CanExecuteFile);
	...
	private void updateTable(TreeItem target) {
		...
		if (RDTPluginMessage.RDTMainWizardPage_CanExecuteFile.equals(str.trim())) {
			input.add(RDTPluginMessage.RDTMainWizardPage_CanExecuteFile_GCCBuilderToolChains);
		...
		} else if (RDTPluginMessage.RDTMainWizardPage_AppModule.equals(str.trim())) {

		} else if (RDTPluginMessage.RDTMainWizardPage_ExtensionsModule.equals(str.trim())) {
