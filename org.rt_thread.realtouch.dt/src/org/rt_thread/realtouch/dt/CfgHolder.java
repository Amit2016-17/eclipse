...
public class CfgHolder {
    ...
    /**
     * Returns corresponding project type obtained either from configuration (if
     * any) or from toolchain.
     * 
     * @return projectType
     */
    ...
    /**
     * Makes configuration's names unique. Adds either version number or
     * toolchain name. If it does not help, simply adds index.
     * 
     * @param its
     *            - list of items.
